...
parser.add_option("-a", dest="all", help="train all", action="store_true")
(options, args) = parser.parse_args()

if options.all:
  classify_names = ["adv_stats_digits", "height_digits", "ovr_digits", "pos", "type"]
  results = {}
  for classify_name in classify_names:
    correct, incorrect, incorrect_list = train(classify_name)
    results[classify_name] = (correct, incorrect, incorrect_list)
  for classify_name in classify_names:
    (correct, incorrect, incorrect_list) = results[classify_name]
    print classify_name
